...
```
/.team-brain/team_ben/                     # Ben团队 Agent 定义和进度
├── codex.md                               # Ben 的 Codex 上下文文件
├── team_chat.md                           # Ben团队群聊（Founder只读）
├── backend.md                             # 后端+数据库 Agent 定义
├── frontend.md                            # 前端联动 Agent 定义
├── pm.md                                  # 协调 Agent 定义
├── backend-progress/                      # 后端 Agent 进度
│   ├── current.md
│   ├── context-for-others.md
│   └── completed.md
├── frontend-progress/                     # 前端 Agent 进度
└── pm-progress/                           # PM Agent 进度
...
| Agent | 启动方式 | 说明 |
|-------|---------|------|
| backend_Ben | Ben 在 Codex 中加载 `.team-brain/team_ben/backend.md` | 数据库+API架构 |
| frontend_Ben | Ben 在 Codex 中加载 `.team-brain/team_ben/frontend.md` | 前端联动 |
| pm_Ben | Ben 在 Codex 中加载 `.team-brain/team_ben/pm.md` | 协调+文档 |
