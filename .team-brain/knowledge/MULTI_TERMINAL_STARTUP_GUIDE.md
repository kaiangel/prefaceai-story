...
| Agent 配置 | `.claude/agents/` | `.team-brain/team_ben/` |
| 进度文件 | `.claude/agents/*-progress/` | `.team-brain/team_ben/*-progress/` |
...
- **Ben 群聊**: `.team-brain/team_ben/TEAM_CHAT.md` — Founder 只读
- **Git**: 两人都直接 push 到 `main` 分支，分工不同代码冲突概率极低
...
```bash
# 读取 Ben 团队进度文件
cat .team-brain/team_ben/backend-progress/current.md
cat .team-brain/team_ben/pm-progress/context-for-others.md
