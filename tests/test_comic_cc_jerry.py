...
# 输出目录（v3版本，V5修复后验收）
OUTPUT_DIR = Path(__file__).parent.parent / "test_output" / "comic_cc_jerry_story_v3"
NO_TEXT_DIR = OUTPUT_DIR / "no_text_images"
WITH_TEXT_DIR = OUTPUT_DIR / "with_text_images"
COMPARISON_DIR = OUTPUT_DIR / "comparison"

# 现有参考图目录（直接加载，不重新生成）
EXISTING_REF_DIR = Path(__file__).parent.parent / "test_output" / "manualtest" / "teststory_CCJerry" / "character_refs"
...
"""
    },
    {
        ...
        "chinese_text": ["Jerry内心：「这件毛衣...应该还行吧？」", "Cici内心：「这条丝巾是点睛之笔。」"],
...
- Slight color temperature difference: cooler left (Jerry), warmer right (Cici)

CHARACTER REFERENCE:
- LEFT (Jerry): FACE REFERENCE ONLY from reference. Use face features and glasses. CLOTHING: dark purple-black knit sweater
...
"""
    },
    {
        ...
        "chinese_text": "Jerry内心：「还有五分钟...她会喜欢这里吗？」",
        "characters": ["Jerry"],
        "image_prompt": f"""{KOREAN_WEBTOON_STYLE_PREFIX}
...
CHARACTER REFERENCE:
- FACE REFERENCE ONLY from Jerry reference image
...
- RIGHT (Jerry): FACE REFERENCE ONLY. CLOTHING: black overcoat, glasses
...
"""
    },
    {
        ...
        "text_type": "thought",
        "speaker_position": "left_bottom,right_bottom",
        "chinese_text": ["Jerry内心：「她笑起来，比照片还好看。」", "Cici内心：「他的眼睛...好温柔。」"],
        "characters": ["Jerry", "Cici"],
        "is_emotional_highlight": True,
        "image_prompt": f"""{KOREAN_WEBTOON_STYLE_PREFIX}
...
LEFT SIDE - Jerry's face in close-up:
...
CHARACTER REFERENCE:
- Jerry: FACE REFERENCE ONLY. Black hair, rectangular glasses, gentle expression
...
"""
    ...
    # === 第四幕：初次对话 (Shots 12-14) ===
    {
        ...
        "chinese_text": ["Jerry：「你好，Cici。终于见到真人了。」", "Cici：「你好，Jerry。」"],
        "characters": ["Jerry", "Cici"],
        "image_prompt": f"""{KOREAN_WEBTOON_STYLE_PREFIX}
...
LEFT - Jerry: tall man in black overcoat, dark sweater underneath, black glasses. He has a warm, slightly nervous smile, standing with good posture, looking at her with gentle eyes.
...
CHARACTER REFERENCE:
- Jerry: FACE REFERENCE ONLY. CLOTHING: black overcoat, dark sweater, glasses
...
"""
    },
    {
        ...
        "chinese_text": ["Cici：「比照片帅嘛。」", "Jerry：「你也是，比照片还漂亮。」"],
        "characters": ["Cici"],
        "image_prompt": f"""{KOREAN_WEBTOON_STYLE_PREFIX}
...
- The silhouette of a tall man (Jerry) slightly visible in soft focus
...
CHARACTER REFERENCE:
- Jerry: FACE REFERENCE ONLY. CLOTHING: black overcoat, glasses. Gentlemanly posture
...
"""
    },
    {
        ...
        "chinese_text": ["Cici：「谢谢。」", "Jerry：「请坐。」", "Cici内心：「好久没遇到这么绅士的男生了。」"],
        "characters": ["Jerry", "Cici"],
        "image_prompt": f"""{KOREAN_WEBTOON_STYLE_PREFIX}
...
CHARACTER REFERENCE:
- Jerry: FACE REFERENCE ONLY. CLOTHING: dark purple-black sweater (coat off). Attentive expression
...
LEFT - Jerry sits with good posture, wearing a dark purple-black sweater. His black glasses reflect the candlelight. His expression is warm but slightly nervous - the endearing awkwardness of a first date.
...
CHARACTER REFERENCE:
- Jerry: FACE REFERENCE ONLY. CLOTHING: dark purple-black sweater, glasses
...
Jerry (left) is pointing at something on the menu, his expression thoughtful and attentive. He wears a dark purple-black sweater and glasses.
...
CHARACTER REFERENCE:
- Jerry: FACE REFERENCE ONLY. CLOTHING: dark purple-black sweater, glasses. Attentive expression
...
"""
    },
    {
        ...
        "text_type": "dialogue",
        "speaker_position": "left,right",
        "chinese_text": ["Cici：「你是做什么工作的？」", "Jerry：「互联网，产品经理。你呢？」", "Cici：「设计师，做品牌视觉的。」"],
        "characters": ["Jerry", "Cici"],
        "image_prompt": f"""{KOREAN_WEBTOON_STYLE_PREFIX}
...
RIGHT - Jerry is listening with a warm smile, his posture attentive. Dark purple-black sweater, glasses reflecting the candlelight.
...
- Jerry: FACE REFERENCE ONLY. Warm listening expression. CLOTHING: dark sweater, glasses
...
Cici is the focus - she's listening intently to Jerry speak. Her expression is captivated and warm. She has one hand resting against her cheek, elbow on table (relaxed, interested posture). Her eyes are bright and focused on him, a soft smile on her lips.
...
Jerry is visible as a soft-focus presence across the table - his gesturing hand, the edge of his sweater, suggesting he's animatedly telling a story.

CHARACTER REFERENCE:
- Cici: FACE REFERENCE ONLY. Captivated, adoring listening expression. CLOTHING: black knit sweater
- Jerry: Partially visible, soft focus
...
"""
    },
    {
        ...
        "text_type": "thought",
        "speaker_position": "bottom",
        "chinese_text": "Jerry内心：「她讲话的样子真好看。」",
        "characters": ["Jerry"],
        "image_prompt": f"""{KOREAN_WEBTOON_STYLE_PREFIX}
...
Jerry is the focus - he's listening to Cici with complete attention. His expression is warm and tender, a gentle smile on his lips. His eyes behind his glasses are soft and admiring. He's leaning slightly forward, completely engaged.
...
CHARACTER REFERENCE:
- Jerry: FACE REFERENCE ONLY. Tender, admiring listening expression. CLOTHING: dark purple-black sweater, glasses
...
{TEXT_FREE_REQUIREMENT}
Jerry's gentle, admiring expression is the focus.
"""
    },
    {
        "shot_id": 22,
...
"""
    ...
    # === 第七幕：甜点时光 (Shots 23-24) ===
    {
        ...
        "text_type": "dialogue",
        "speaker_position": "left,right",
        "chinese_text": ["Jerry：「你试试这个，他们家招牌。」", "Cici：「看起来好好吃！」"],
        "characters": ["Jerry", "Cici"],
        "image_prompt": f"""{KOREAN_WEBTOON_STYLE_PREFIX}
...
LEFT - Jerry gestures toward the tiramisu with a recommending expression, looking at Cici. He wears a dark purple-black sweater, glasses.
...
CHARACTER REFERENCE:
- Jerry: FACE REFERENCE ONLY. Recommending, pleased expression. CLOTHING: dark purple-black sweater, glasses
- Cici: FACE REFERENCE ONLY. Delighted, excited expression. CLOTHING: BLACK knit sweater (NOT beige, NOT brown!)

CHARACTER CONSISTENCY REQUIREMENT:
- Jerry: MUST wear dark purple-black sweater with glasses
...
"""
    },
    {
        ...
        "text_type": "dialogue_with_thought",
        "speaker_position": "top,bottom",
        "chinese_text": ["Jerry：「尝尝。」", "Cici内心：「这也太自然了...我们才第一次见面诶。」"],
        "characters": ["Jerry", "Cici"],
        "image_prompt": f"""{KOREAN_WEBTOON_STYLE_PREFIX}
...
Jerry's expression is gentle and encouraging, holding the spoon steadily. He wears a dark purple-black sweater, glasses.
...
CHARACTER REFERENCE:
- Jerry: FACE REFERENCE ONLY. Gentle, caring expression. CLOTHING: dark sweater, glasses
...
Jerry holds the door, wearing his black overcoat over dark sweater, glasses catching the light. His expression is content and happy.
...
CHARACTER REFERENCE:
- Jerry: FACE REFERENCE ONLY. Content expression. CLOTHING: black overcoat, glasses
...
Jerry is on the left, tall in his black overcoat, hands in pockets. Cici is on the right, her red scarf bright against the night, hair flowing behind her. Both are talking and smiling, comfortable with each other.
...
CHARACTER REFERENCE:
- Jerry: FACE REFERENCE ONLY. Relaxed, happy expression. CLOTHING: black overcoat
...
"""
    },
    {
        ...
        "characters": ["Jerry", "Cici"],
        "image_prompt": f"""{KOREAN_WEBTOON_STYLE_PREFIX}
MEDIUM SHOT from the side, capturing a sweet moment as a young couple crosses a nighttime street. Jerry instinctively places his hand gently on Cici's back - a natural protective gesture as they cross together.

Jerry on the left in black overcoat, his right hand lightly touching Cici's upper back, guiding her across. Cici on the right in black coat with red scarf. This is a PROTECTIVE TOUCH, not romantic - the gesture of someone naturally watching out for another.

Cici's expression shows pleasant surprise at his thoughtfulness - eyes widening slightly, a small smile forming. Jerry's expression is calm and attentive, looking ahead to check for traffic while keeping her safe.
...
CHARACTER REFERENCE:
- Jerry: FACE REFERENCE ONLY. Calm protective expression, watching ahead. CLOTHING: black overcoat
...
"""
    },
    {
        ...
        "text_type": "thought",
        "speaker_position": "top",
        "chinese_text": "Jerry内心：「我可以...牵她的手吗？」",
        "characters": [],
        "image_prompt": f"""{KOREAN_WEBTOON_STYLE_PREFIX}
...
CHARACTER DETAILS:
- Jerry's hand: masculine but gentle, relaxed at his side
...
CHARACTER REFERENCE:
- Jerry: defined masculine hand, black coat, leather watch
- Cici: delicate feminine hand, black coat, RED scarf visible, gold bracelet

CHARACTER CONSISTENCY REQUIREMENT:
- Jerry: MUST wear BLACK wool overcoat
...
Jerry stands on the left, his expression showing he doesn't want the evening to end. He holds her hand gently.
...
CHARACTER REFERENCE:
- Jerry: FACE REFERENCE ONLY. Reluctant, hopeful expression. CLOTHING: black overcoat
...
"""
    },
    {
        ...
        "text_type": "dialogue",
        "speaker_position": "left,right",
        "chinese_text": ["Jerry：「我开车送你吧。这个点地铁挤。」", "Cici：「可是...你不顺路吧？」", "Jerry：「送你回家，就是最顺的路。」"],
        "characters": ["Jerry", "Cici"],
        "image_prompt": f"""{KOREAN_WEBTOON_STYLE_PREFIX}
CLOSE TWO-SHOT of the couple facing each other near the metro entrance. The moment Jerry offers to drive her home.

Jerry's expression is earnest and gentlemanly, looking at her with warmth. He gestures slightly toward another direction (where his car might be parked).
...
CHARACTER REFERENCE:
- Jerry: FACE REFERENCE ONLY. Earnest, charming expression. CLOTHING: black overcoat, glasses
...
"""
    ...
    # === 第十幕：车内时光 (Shots 32-35) ===
    {
        ...
        "characters": ["Jerry", "Cici"],
        "image_prompt": f"""{KOREAN_WEBTOON_STYLE_PREFIX}
MEDIUM to WIDE SHOT of a young couple walking through a quiet parking area at night. Jerry leads slightly, looking back at Cici with a warm expression. She follows with a happy, trusting smile.
...
CHARACTER REFERENCE:
- Jerry: FACE REFERENCE ONLY. Looking back warmly. CLOTHING: black overcoat
...
"""
    },
    {
        ...
        "chinese_text": ["Jerry：「请上车。」", "Cici内心：「今晚被照顾得太好了...」"],
        "characters": ["Jerry", "Cici"],
        "image_prompt": f"""{KOREAN_WEBTOON_STYLE_PREFIX}
MEDIUM SHOT of Jerry holding open the passenger door of his car for Cici. The chivalrous gesture captured mid-action.

Jerry stands by the open door with a gentle, inviting expression, gesturing for her to enter. His posture is attentive and caring.
...
CHARACTER REFERENCE:
- Jerry: FACE REFERENCE ONLY. Gentle, inviting expression. CLOTHING: black overcoat
...
"""
    },
    {
        ...
        "text_type": "dialogue",
        "speaker_position": "left,right",
        "chinese_text": ["Cici：「你开车很稳。」", "Jerry：「副驾有贵客，当然要稳。」"],
        "characters": ["Jerry"],
        "image_prompt": f"""{KOREAN_WEBTOON_STYLE_PREFIX}
...
"""
    },
    {
        ...
        "text_type": "dialogue",
        "speaker_position": "left,right",
        "chinese_text": ["Cici：「今天...真的很开心。谢谢你。」", "Jerry：「我也是。谢谢你愿意来见我。」"],
        "characters": ["Jerry", "Cici"],
        "image_prompt": f"""{KOREAN_WEBTOON_STYLE_PREFIX}
...
Jerry looks down at her with warmth and the unspoken wish for more time. His expression is gentle, protective.
...
- Jerry: FACE REFERENCE ONLY. Warm, protective, reluctant expression. CLOTHING: black overcoat, glasses
...
"""
    },
    {
        ...
        "text_type": "narration_with_thought",
        "speaker_position": "top,bottom",
        "chinese_text": ["旁白：「她上前一步，抱住了他。没有犹豫。」", "Jerry内心：「她身上有淡淡的香味...像是...柑橘和茉莉。」"],
        "characters": ["Jerry", "Cici"],
        "is_emotional_highlight": True,
        "image_prompt": f"""{KOREAN_WEBTOON_STYLE_PREFIX}
⭐ EMOTIONAL HIGHLIGHT SHOT ⭐

MEDIUM SHOT of an embrace under the warm glow of a street lamp. Cici has stepped forward and wrapped her arms around Jerry. He embraces her back, his arms gentle around her.
...
CHARACTER REFERENCE:
- Jerry: FACE REFERENCE ONLY. Touched, gentle happiness. CLOTHING: BLACK wool overcoat (not any other color)
...
Jerry's eyes behind his glasses are soft and deep, looking down at her. His expression shows tender wonder and restrained longing.
...
- Jerry: FACE REFERENCE ONLY. Tender wonder, restrained longing. CLOTHING: BLACK wool overcoat, glasses
...
CLOSE-UP SHOT capturing the moment Jerry leans in to steal a gentle kiss on Cici's cheek - a sweet, spontaneous gesture of affection.
...
CHARACTER REFERENCE:
- Jerry: FACE REFERENCE ONLY. Eyes gently closed, leaning in for the kiss. CLOTHING: BLACK wool overcoat, glasses
...
"""
    },
    {
        ...
        "text_type": "thought",
        "speaker_position": "bottom",
        "chinese_text": "Jerry内心：「这一刻，我知道...她就是那个人。」",
        "characters": ["Jerry"],
        "image_prompt": f"""{KOREAN_WEBTOON_STYLE_PREFIX}
CLOSE-UP on Jerry's face, capturing his reaction right after he kissed Cici's cheek. He's watching her reaction with nervous anticipation.
...
CHARACTER REFERENCE:
- Jerry: FACE REFERENCE ONLY. Nervous hopeful expression, slight blush, watching for her reaction. CLOTHING: black overcoat, glasses
...
IN FOREGROUND: Jerry stands watching, his expression a soft, content smile. He raises one hand in a gentle wave.
...
CHARACTER REFERENCE:
- Jerry (foreground): FACE REFERENCE ONLY. Content, soft smile, waving. CLOTHING: black overcoat
...
# 这确保了所有故事（Jerry与Cici、武侠、赛博朋克等）使用相同的实现
...
def load_existing_reference_images() -> Dict[str, Image.Image]:
    ...
    # Jerry fullbody
    kai_path = EXISTING_REF_DIR / "Jerry_fullbody.png"
    if kai_path.exists():
        ref_images["Jerry"] = Image.open(kai_path)
        print(f"  ✅ 加载 Jerry 参考图: {kai_path}")
    else:
        print(f"  ⚠️ Jerry 参考图不存在: {kai_path}")
...
async def run_cc_jerry_story_test():
    """运行Jerry与Cici故事测试"""

    print("=" * 70)
    print("Jerry与Cici初次约会 - 条漫故事测试")
    ...
    # TASK-RENAME-KAI-TO-JERRY: 只生成shot_12验证
    ONLY_SHOT_12 = True  # 设为False可生成全部42张

    for shot in FULL_STORY_SHOTS:
        shot_id = shot["shot_id"]

        # 只生成shot_12验证
        if ONLY_SHOT_12 and shot_id != 12:
            continue
...
if __name__ == "__main__":
    asyncio.run(run_cc_jerry_story_test())
